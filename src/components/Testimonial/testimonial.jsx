    ...
    <div className="testimonial-container">
      ...
      <Slider {...settings}>
        {testimonials.map((testimonial, index) => (
          <div key={testimonial.id} className="testimonial-slide">
            <img src={testimonial.image} alt={t(`testimonial${index + 1}.name`)} className="testimonial-image" />
            <p className="testimonial-text">"{t(`testimonial${index + 1}.text`)}"</p>
            <h3 className="testimonial-name">- {t(`testimonial${index + 1}.name`)}</h3>
          </div>
        ))}
      </Slider>
    </div>
