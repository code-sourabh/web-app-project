  ...
  return (
    <div className="bg-gradient-to-br from-orange-50 to-white flex flex-col mt-3">
      <div className="container mx-auto px-4 py-8 flex-grow flex flex-col justify-between">
        ...
        <div className="mt-6">
          <div>
            <h2 className="text-3xl font-bold text-gray-800 text-center mb-6">{t('industryPage.features.title')}</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="text-xl font-semibold text-gray-800 text-center">{t('industryPage.features.scalableSolutions.title')}</h3>
                <p className="text-gray-600 text-center">{t('industryPage.features.scalableSolutions.description')}</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="text-xl font-semibold text-gray-800 text-center">{t('industryPage.features.secureInfrastructure.title')}</h3>
                <p className="text-gray-600 text-center">{t('industryPage.features.secureInfrastructure.description')}</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <h3 className="text-xl font-semibold text-gray-800 text-center">{t('industryPage.features.innovativeSolutions.title')}</h3>
                <p className="text-gray-600 text-center">{t('industryPage.features.innovativeSolutions.description')}</p>
              </div>
            </div>
          </div>
        </div>
