...
//           <h1 className="text-[2.5rem] md:text-5xl font-bold text-gray-800 mb-4 text-center">
//             {content.title}
//           </h1>
...
//             <p className="text-gray-700 text-center text-[1rem]">{content.para1}</p>
//             <p className="text-gray-700 text-center text-[1rem]">{content.para2}</p>
//           </div>
//         </div>
...
//                     </svg>
//                   </div>
//                   <h3 className="text-[1.5rem] font-semibold text-gray-800 text-center">
//                     {feature.title}
//                   </h3>
...
const IndustryPage = () => {
  ...
  const getContent = (type) => {
    ...
    return {
      ...
      keyFeatures: [
        {
          title: content.keyFeatures.feature1.title,
          description: content.keyFeatures.feature1.description,
        },
        {
          title: content.keyFeatures.feature2.title,
          description: content.keyFeatures.feature2.description,
        },
        {
          title: content.keyFeatures.feature3.title,
          description: content.keyFeatures.feature3.description,
        },
      ],
      useCases: [
        {
          title: content.useCases.case1.title,
          description: content.useCases.case1.description,
          image: cloud1,
        },
        {
          title: content.useCases.case2.title,
          description: content.useCases.case2.description,
          image: cloud2,
        },
        {
          title: content.useCases.case3.title,
          description: content.useCases.case3.description,
          image: cloud3,
        },
      ],
    };
    ...
    <div id="industry" className="bg-gradient-to-br from-orange-50 to-white flex flex-col mt-16">
      <div className="container mx-auto px-4 py-8 flex-grow flex flex-col justify-between">
        ...
        <div className="mt-6">
          <div>
            <h2 className="text-[2.5rem] font-bold text-gray-800 text-center mb-6">
              {t('industryPage.common.keyFeatures')}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
