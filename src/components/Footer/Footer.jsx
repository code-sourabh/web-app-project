...
const Footer = () => {
  ...
  const FooterLinks = [
    { title: t('services.cloudServices'), link: "/services/cloud-services" },
    { title: t('services.applicationServices'), link: "/services/application-services" },
    { title: t('services.cyberSecurity'), link: "/services/cyber-security" },
    { title: t('services.dataAnalytics'), link: "/services/data-analytics" },
    { title: t('services.automation'), link: "/services/automation" },
    { title: t('services.infrastructure'), link: "/services/infrastructure" },
  ];

  const IndustryLinks = [
    { title: t('industry.finance'), link: "/industries/finance" },
    { title: t('industry.technology'), link: "/industries/technology" },
    { title: t('industry.banking'), link: "/industries/banking" },
    { title: t('industry.telecom'), link: "/industries/telecom" },
    { title: t('industry.media'), link: "/industries/media" },
  ];

  const KnowUsLinks = [
    { title: t('knowUs.about'), link: "/about" },
    { title: t('knowUs.leaders'), link: "/leaders" },
    { title: t('knowUs.customerService'), link: "/contact" },
    { title: t('knowUs.partners'), link: "/partner" },
    { title: t('knowUs.blogs'), link: "/blogs" },
  ];
            ...
            <div className="py-8 px-4 text-white">
              ...
              <ul className="flex flex-col gap-3 text-white">
                {FooterLinks.map((link) => (
                  <li
                    key={link.link}
                    className="cursor-pointer hover:translate-x-1 duration-300 hover:!text-primary space-x-1 text-gray-100 dark:text-black text-start text-[0.8rem]"
                  >
            ...
            <div className="py-8 px-4">
              ...
              <ul className="flex flex-col gap-3">
                {IndustryLinks.map((link) => (
                  <li
                    key={link.link}
                    className="cursor-pointer hover:translate-x-1 duration-300 hover:!text-primary space-x-1 text-gray-700 dark:text-black text-left text-[0.8rem]"
                  >
                    <Link to={link.link} onClick={() => window.scrollTo(0, 0)}>
                      <span className="text-white">{link.title}</span>
                    </Link>
